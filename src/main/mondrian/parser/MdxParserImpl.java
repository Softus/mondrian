...
// <identifier> ::= <regularIdentifier> | <delimitedIdentifier>
  ...
  final public Id.Segment nameSegment() throws ParseException {
    String id;
    ...
    case PROPERTIES:
      id = keyword();
        ...
        {if (true) return new Id.Segment(id, Id.Quoting.UNQUOTED);}
      break;
    case ID:
      jj_consume_token(ID);
        {if (true) return new Id.Segment(token.image, Id.Quoting.UNQUOTED);}
      break;
    case QUOTED_ID:
      jj_consume_token(QUOTED_ID);
        {if (true) return new Id.Segment(
  ...
  final public Id.Segment ampId() throws ParseException {
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case AMP_QUOTED_ID:
  ...
  final public Query selectStatement() throws ParseException {
    ...
    default:
      ...
      ;
        ...
        // yet.
        String cubeName = ((Id.Segment) c.getElement(0)).name;

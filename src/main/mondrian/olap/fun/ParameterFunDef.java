/*
// $Id: //open/mondrian-release/3.1/src/main/mondrian/olap/fun/ParameterFunDef.java#2 $
 ...
 *
 * @author jhyde
 * @version $Id: //open/mondrian-release/3.1/src/main/mondrian/olap/fun/ParameterFunDef.java#2 $
 * @since Feb 14, 2003
 */

/*
// $Id: //open/mondrian-release/3.1/src/main/mondrian/olap/fun/IntersectFunDef.java#2 $
 ...
 *
 * @author jhyde
 * @version $Id: //open/mondrian-release/3.1/src/main/mondrian/olap/fun/IntersectFunDef.java#2 $
 * @since Mar 23, 2006
 */

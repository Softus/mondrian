/*
// $Id: //open/mondrian-release/3.1/src/main/mondrian/olap/fun/AggregateFunDef.java#2 $
 ...
 * @author jhyde
 * @since 2005/8/14
 * @version $Id: //open/mondrian-release/3.1/src/main/mondrian/olap/fun/AggregateFunDef.java#2 $
 */

/*
// $Id: //open/mondrian-release/3.1/src/main/mondrian/rolap/aggmatcher/AggStar.java#2 $
 ...
 * @version $Id: //open/mondrian-release/3.1/src/main/mondrian/rolap/aggmatcher/AggStar.java#2 $
 */
...
//                    getAggStar().setForeignKey(c.getBitPosition());
        ...
        private void makeNumberOfRows() {
            ...
            if (DatabaseProduct.POSTGRESQL == query.getDialect().getDatabaseProduct()
                    && getRelation() instanceof MondrianDef.Table)
            {

/*
// $Id: //open/mondrian-release/3.1/testsrc/main/mondrian/test/AccessControlTest.java#6 $
 ...
 * @author jhyde
 * @since Feb 21, 2003
 * @version $Id: //open/mondrian-release/3.1/testsrc/main/mondrian/test/AccessControlTest.java#6 $
 */
public class AccessControlTest extends FoodMartTestCase {
    ...
    public void _testSharedObjectsInGrantMappingsBug() {
        final TestContext testContext = new TestContext() {
            public Connection getConnection() {
                ...
                role.grant(measuresInSales, Access.ALL, Access.ALL, null, null,
                    rollupPolicy);
    ...
    private Connection getRestrictedConnection(boolean restrictCustomers) {
        ...
        Role.RollupPolicy rollupPolicy = Role.RollupPolicy.FULL;
        role.grant(storeHierarchy, Access.CUSTOM, Access.CUSTOM, nationLevel,
            null, rollupPolicy);
        role.grant(
            schemaReader.getMemberByUniqueName(
